...
public interface DialogViewContainerMessages extends Messages
{
	...
	@DefaultMessage("<p>Dialog View Container é um container de views que utiliza uma caixa de diálogo "
			+ "flutuante para renderizá-las.</p> <p>No exemplo apresentado 2 views são carregadas em momentos "
			+ "diferentes, cada uma delas possui um botão para chamar e carregar a próxima "
			+ "view no container</p>")
	String htmlDescText();
}
